...
// Layer 4 : Parse Line for different language sections
	...
	void CParser :: ParseLineForStructureDefinition ( CString aText ) {
		...
		// Statement not recognized
			if ( aText != "" ) {
				MessageBox ( 0 , ( CString ) "Syntax error: statement not recognized." + "\r\n" + "\r\n" + Lines -> GetAt ( LineIndex ) , ApplicationName ( ) , MB_OK ) ;
			}
	Exit:
		delete tTokens ;
	} ;
				...
				for ( i = 0 ; i <= aTokens -> GetSize ( ) - 1 ; i ++ ) {
					...
					if ( tToken != "" ) {
						...
						switch ( tFilledTokenIndex ) {
							case 0 :
								// "Class"
									if ( tToken != "Class" ) {
										...
										MessageBox ( 0 , ( CString ) "Syntax error. First token of a Class declaration must be 'Class', not " + "'" + tToken + "'" + "." + "\r\n" + "\r\n" + Lines -> GetAt ( LineIndex ) , ApplicationName ( ) , MB_OK ) ;
										return ;
									}
								break ;
							case 1 :
							...
							case 2 : 
								if ( tToken != "//" ) {
									MessageBox ( 0 , ( CString ) "Syntax error parsing Class declaration. Statement can only be followed by comment, not " + "'" + tToken + "'" + "." + "\r\n" + "\r\n" + Lines -> GetAt ( LineIndex ) , ApplicationName ( ) , MB_OK ) ;
								}
						}
					}
				}
							...
							case 1 :
								// "-->"
									if ( tToken != "-->" ) {
										...
										MessageBox ( 0 , ( CString ) "Syntax error. Second token of an Attribute declaration must be '-->', not " + "'" + tToken + "'" + "." + "\r\n" + "\r\n" + Lines -> GetAt ( LineIndex ) , ApplicationName ( ) , MB_OK ) ;
										return ;
									}
								break ;
							case 2 :
							...
							case 3 :
								// "("
									if ( tToken != "(" ) {
										...
										MessageBox ( 0 , ( CString ) "Syntax error. Fourth token of an Attribute declaration must be '(', not " + "'" + tToken + "'" + "." + "\r\n" + "\r\n" + Lines -> GetAt ( LineIndex ) , ApplicationName ( ) , MB_OK ) ;
										return ;
									}
								break ;
							case 4 :
							...
							case 5 :
								// ")"
									if ( tToken != ")" ) {
										...
										MessageBox ( 0 , ( CString ) "Syntax error. Sixth token of an Attribute declaration must be ')', not " + "'" + tToken + "'" + "." + "\r\n" + "\r\n" + Lines -> GetAt ( LineIndex ) , ApplicationName ( ) , MB_OK ) ;
										return ;
									}
								break ;
							case 6 :
								if ( tToken != "//" ) {
									MessageBox ( 0 , ( CString ) "Syntax error parsing Attribute declaration. Statement can only be followed by comment, not " + "'" + tToken + "'" + "." + "\r\n" + "\r\n" + Lines -> GetAt ( LineIndex ) , ApplicationName ( ) , MB_OK ) ;
								}
						}
					}
				}
						...
						switch ( tFilledTokenIndex ) {
							...
							case 1 :
								// "("
									if ( tToken != "(" ) {
										// Error : 2nd filled token must be "(""
										MessageBox ( 0 , ( CString ) "Syntax error. Second token of a Relation declaration must be '(', not " + "'" + tToken + "'" + "." + "\r\n" + "\r\n" + Lines -> GetAt ( LineIndex ) , ApplicationName ( ) , MB_OK ) ;
										return ;
									}
								break ;
							case 2 :
							...
							case 3 :
								// ")"
									if ( tToken != ")" ) {
										// Error : 4th filled token must be ")"
										MessageBox ( 0 , ( CString ) "Syntax error. Fourth token of a Relation declaration must be ')', not " + "'" + tToken + "'" + "." + "\r\n" + "\r\n" + Lines -> GetAt ( LineIndex ) , ApplicationName ( ) , MB_OK ) ;
										return ;
									}
								break ;
							case 4 :
							...
							case 5 :
								// "-->"
									if ( tToken != "-->" ) {
										...
										MessageBox ( 0 , ( CString ) "Syntax error. Seventh token of a Relation declaration must be '-->', not " + "'" + tToken + "'" + "." + "\r\n" + "\r\n" + Lines -> GetAt ( LineIndex ) , ApplicationName ( ) , MB_OK ) ;
										return ;
									}
							case 6 :
							...
							case 8 :
								// "("
									if ( tToken != "(" ) {
										...
										MessageBox ( 0 , ( CString ) "Syntax error. Ninth token of a Relation declaration must be '(', not " + "'" + tToken + "'" + "." + "\r\n" + "\r\n" + Lines -> GetAt ( LineIndex ) , ApplicationName ( ) , MB_OK ) ;
										return ;
									}
								break ;
							case 9 :
							...
							case 10 :
								// ")"
									if ( tToken != ")" ) {
										// Error : 11th filled token must be ")"
										MessageBox ( 0 , ( CString ) "Syntax error. Eleventh token of a Relation declaration must be ')', not " + "'" + tToken + "'" + "." + "\r\n" + "\r\n" + Lines -> GetAt ( LineIndex ) , ApplicationName ( ) , MB_OK ) ;
										return ;
									}
								break ;
							case 11 : 
								if ( tToken != "//" ) {
									MessageBox ( 0 , ( CString ) "Syntax error parsing Relation declaration. Statement can only be followed by comment, not " + "'" + tToken + "'" + "." + "\r\n" + "\r\n" + Lines -> GetAt ( LineIndex ) , ApplicationName ( ) , MB_OK ) ;
								}
						}
					}
				}
				...
				for ( i = 0 ; i <= aTokens -> GetSize ( ) - 1 ; i ++ ) {
					...
					if ( tToken != "" ) {
						...
						switch ( tFilledTokenIndex ) {
							...
							case 2 :
								if ( tToken != "//" ) {
									MessageBox ( 0 , ( CString ) "Syntax error parsing Name declaration. Statement can only be followed by comment, not " + "'" + tToken + "'" + "." + "\r\n" + "\r\n" + Lines -> GetAt ( LineIndex ) , ApplicationName ( ) , MB_OK ) ;
								}
						}
					}
				}
				...
				for ( i = 0 ; i <= aTokens -> GetSize ( ) - 1 ; i ++ ) {
					...
					if ( tToken != "" ) {
						...
						switch ( tFilledTokenIndex ) {
							case 0 :
								// "Method"
									if ( tToken != "Method" ) {
										...
										MessageBox ( 0 , ( CString ) "Syntax error. First token of a Method declaration must be 'Method', not " + "'" + tToken + "'" + "." + "\r\n" + "\r\n" + Lines -> GetAt ( LineIndex ) , ApplicationName ( ) , MB_OK ) ;
										return ;
									}
								break ;
							case 1 :
							...
							case 2 :
								// .
									if ( tToken != "." ) {
										...
										MessageBox ( 0 , ( CString ) "Syntax error. Third token of a Method declaration must be '.', not " + "'" + tToken + "'" + "." + "\r\n" + "\r\n" + Lines -> GetAt ( LineIndex ) , ApplicationName ( ) , MB_OK ) ;
										return ;
									}
								break ;
							case 3 :
							...
							case 4 :
								if ( tToken != "//" ) {
									MessageBox ( 0 , ( CString ) "Syntax error parsing Method declaration. Statement can only be followed by comment, not " + "'" + tToken + "'" + "." + "\r\n" + "\r\n" + Lines -> GetAt ( LineIndex ) , ApplicationName ( ) , MB_OK ) ;
								}
						}
					}
				}
						...
						switch ( tFilledTokenIndex ) {
							case 0 :
								// "Name"
									if ( tToken != "Debug" ) {
										// Error : 1st filled token must be "Method"
										MessageBox ( 0 , ( CString ) "Syntax error. First token of a Debug declaration must be 'Debug', not " + "'" + tToken + "'" + "." + "\r\n" + "\r\n" + Lines -> GetAt ( LineIndex ) , ApplicationName ( ) , MB_OK ) ;
										return ;
									}
								break ;
							case 1 :
							...
							case 2 :
								// .
									if ( tToken != "." ) {
										// Error : 3rd filled token must be "."
										MessageBox ( 0 , ( CString ) "Syntax error. Third token of a Debug declaration must be '.', not " + "'" + tToken + "'" + "." + "\r\n" + "\r\n" + Lines -> GetAt ( LineIndex ) , ApplicationName ( ) , MB_OK ) ;
										return ;
									}
								break ;
							case 3 :
							...
							case 4 :
								if ( tToken != "//" ) {
									MessageBox ( 0 , ( CString ) "Syntax error parsing Debug declaration. Statement can only be followed by comment, not " + "'" + tToken + "'" + "." + "\r\n" + "\r\n" + Lines -> GetAt ( LineIndex ) , ApplicationName ( ) , MB_OK ) ;
								}
						}
					}
				}
		...
		// Parse Method Definition
			...
			void CParser :: ParseOverriddenMethodDefinition ( CArray<CString , CString>* aTokens ) {
				...
				// When End Tag is found, store its line position.
					...
					if ( tLastLine == -1 ) {
						...
						MessageBox ( 0 , ( CString ) "Syntax error parsing Overridden Method definition. 'End  Method' not found" , ApplicationName ( ) , MB_OK ) ;
					}
				// Combine the lines between start and end line to one string.
				...
				// Store the text in a file in the appropriate location.
					if ( FileExists ( tStructureFolder ) ) {
						CString tFilePath = tStructureFolder + "\\" + ResolveInvalidFileNameCharacters ( tStructureName + "  .  " + tClassName + "  .  " + tMemberName ) ;
						...
						switch ( tFilledTokenIndex ) {
							case 0 :
								// "Method"
									if ( tToken != "Method" ) {
										// Error : 1st filled token must be "Method"
										MessageBox ( 0 , ( CString ) "Syntax error. First token of an Overridden Method definition must be 'Method', not " + "'" + tToken + "'" + "." + "\r\n" + "\r\n" + Lines -> GetAt ( LineIndex ) , ApplicationName ( ) , MB_OK ) ;
										return ;
									}
								break ;
							case 1 :
								// "Overrides"
									if ( tToken != "Override" ) {
										// Error : 2nd filled token must be "Method"
										MessageBox ( 0 , ( CString ) "Syntax error. First token of an Overridden Method definition must be 'Override', not " + "'" + tToken + "'" + "." + "\r\n" + "\r\n" + Lines -> GetAt ( LineIndex ) , ApplicationName ( ) , MB_OK ) ;
										return ;
									}
								break ;
							case 2 :
							...
							case 3 :
								// .
									if ( tToken != "." ) {
										// Error : 4th filled token must be "."
										MessageBox ( 0 , ( CString ) "Syntax error. Fourth token of an Overridden Method definition must be '.', not " + "'" + tToken + "'" + "." + "\r\n" + "\r\n" + Lines -> GetAt ( LineIndex ) , ApplicationName ( ) , MB_OK ) ;
										return ;
									}
								break ;
							case 4 : 
							...
							case 5 :
								// .
									if ( tToken != "." ) {
										// Error : 6th filled token must be "."
										MessageBox ( 0 , ( CString ) "Syntax error. Sixth token of an Overridden Method definition must be '.', not " + "'" + tToken + "'" + "." + "\r\n" + "\r\n" + Lines -> GetAt ( LineIndex ) , ApplicationName ( ) , MB_OK ) ;
										return ;
									}
								break ;
							case 6 : 
							...
							case 9 :
								if ( tToken != "//" ) {
									MessageBox ( 0 , ( CString ) "Syntax error parsing Overridden Method definition. Statement can only be followed by comment, not " + "'" + tToken + "'" + "." + "\r\n" + "\r\n" + Lines -> GetAt ( LineIndex ) , ApplicationName ( ) , MB_OK ) ;
								}
						}
					}
				}
			...
			void CParser :: ParseCustomMethodDefinition ( CArray<CString , CString>* aTokens ) {
				...
				// When End Tag is found, store its line position.
					...
					if ( tLastLine == -1 ) {
						// Error :  End  Method  not found.
						MessageBox ( 0 , ( CString ) "Syntax error parsing Custom Method definition. 'End  Method' not found" , ApplicationName ( ) , MB_OK ) ;
					}
				// Combine the lines between start and end line to one string.
					CString tMethodContents = Join ( Lines , "\r\n" , tFirstLine + 1 , tLastLine - 1 ) ;
				// Retrieve the Structure Name and Folder.
				...
				// Store the text in a file in the appropriate location.
					if ( FileExists ( tStructureFolder ) ) {
						CString tFilePath = tStructureFolder + "\\" + ResolveInvalidFileNameCharacters ( tStructureName + "  .  " + tClassName + "  .  " + tMethodName + ".crm" ) ;
						SaveString ( & tMethodContents , tFilePath ) ;
					}
				// Add Method To Class
					CItem* tClass = 0 ;
						...
						switch ( tFilledTokenIndex ) {
							case 0 :
								// "Method"
									if ( tToken != "Method" ) {
										// Error : 1st filled token must be "Method"
										MessageBox ( 0 , ( CString ) "Syntax error. First token of a Custom Method declaration must be 'Method', not " + "'" + tToken + "'" + "." + "\r\n" + "\r\n" + Lines -> GetAt ( LineIndex ) , ApplicationName ( ) , MB_OK ) ;
										return ;
									}
								break ;
							case 1 :
							...
							case 2 :
								// .
									if ( tToken != "." ) {
										// Error : 3rd filled token must be "."
										MessageBox ( 0 , ( CString ) "Syntax error. Third token of a Custom Method declaration must be '.', not " + "'" + tToken + "'" + "." + "\r\n" + "\r\n" + Lines -> GetAt ( LineIndex ) , ApplicationName ( ) , MB_OK ) ;
										return ;
									}
								break ;
							case 3 : 
							...
							case 4 :
								if ( tToken != "//" ) {
									MessageBox ( 0 , ( CString ) "Syntax error parsing Custom Method declaration. Statement can only be followed by comment, not " + "'" + tToken + "'" + "." + "\r\n" + "\r\n" + Lines -> GetAt ( LineIndex ) , ApplicationName ( ) , MB_OK ) ;
								}
						}
					}
				}
...
// Layer : Compile Methods
	...
	void CParser :: CompileAttributeMethodDll (
		...
		CString tGetSourcePath = aStructureFolder + "\\" + ResolveInvalidFileNameCharacters ( aStructureName + "  .  " + aClassName + "  .  " + aAttributeName + "  .  Get" + ".crm" ) ;
		CString tSetSourcePath = aStructureFolder + "\\" + ResolveInvalidFileNameCharacters ( aStructureName + "  .  " + aClassName + "  .  " + aAttributeName + "  .  Set" + ".crm" ) ;
		if ( FileExists ( tGetSourcePath ) || FileExists ( tSetSourcePath ) ) {
			...
			// Build DLL
				...
				tBuildCommand += ( CString ) "Echo " + ResolveInvalidFileNameCharacters ( aStructureName + "  .  " + aClassName + "  .  " + aAttributeName ) + "\r\n" ;
			...
			// Copy Output DLL
				...
				CString tTargetDllFilePath = aStructureFolder + "\\" + ResolveInvalidFileNameCharacters ( aStructureName + "  .  " + aClassName + "  .  " + aAttributeName + ".dll" ) ;
				if ( FileExists ( tSourceDllFilePath ) ) {
					CopyFile (
						tSourceDllFilePath  ,
						tTargetDllFilePath , FALSE ) ;
				}
		}
	};
	...
	void CParser :: CompileMethodDll (
		...
		CString tMethodCodeSourcePath = aStructureFolder + "\\" + ResolveInvalidFileNameCharacters ( aStructureName + "  .  " + aClassName + "  .  " + aMethodName + ".crm" ) ;
		if ( FileExists ( tMethodCodeSourcePath ) ) {
			...
			// Build DLL
				CString tBuildCommand = "";
				tBuildCommand += ( CString ) "Echo " + ResolveInvalidFileNameCharacters ( aStructureName + "  .  " + aClassName + "  .  " + aMethodName ) + "\r\n" ;
				tBuildCommand += ( CString ) "Echo -----" + "\r\n" ;
			...
			// Copy Output DLL
				...
				if ( FileExists ( tSourceDllFilePath ) ) {
					CopyFile (
						tSourceDllFilePath  ,
						aStructureFolder + "\\" + ResolveInvalidFileNameCharacters ( aStructureName + "  .  " + aClassName + "  .  " + aMethodName + ".dll" ) , FALSE ) ;
				}
		}
	};
	...
	void CParser :: CompileRelatedItemMethodDll (
		...
		CString tGetSourcePath = aStructureFolder + "\\" + ResolveInvalidFileNameCharacters ( aStructureName + "  .  " + aClassName + "  .  " + aRelatedClassName + "  .  Get" + ".crm" ) ;
		CString tSetSourcePath = aStructureFolder + "\\" + ResolveInvalidFileNameCharacters ( aStructureName + "  .  " + aClassName + "  .  " + aRelatedClassName + "  .  Set" + ".crm" ) ;
		if ( FileExists ( tGetSourcePath ) || FileExists ( tSetSourcePath ) ) {
			...
			// Build DLL
				...
				CString tBuildCommand = "";
				tBuildCommand += ( CString ) "Echo " + ResolveInvalidFileNameCharacters ( aStructureName + "  .  " + aClassName + "  .  " + aRelatedClassName ) + "\r\n" ;
				tBuildCommand += ( CString ) "Echo -----" + "\r\n" ;
			...
			// Copy Output DLL
				...
				if ( FileExists ( tSourceDllFilePath ) ) {
					CopyFile (
						tSourceDllFilePath  ,
						aStructureFolder + "\\" + ResolveInvalidFileNameCharacters ( aStructureName + "  .  " + aClassName + "  .  " + aRelatedClassName + ".dll" ) , FALSE ) ;
				}
				else {
					return ;
				} 
	...
	void CParser :: CompileRelatedListMethodDll (
		...
		CString tItemGetSourcePath = aStructureFolder + "\\" + ResolveInvalidFileNameCharacters ( aStructureName + "  .  " + aClassName + "  .  " + aRelatedClassName + "  .  Item  .  Get" + ".crm" ) ;
		CString tItemSetSourcePath = aStructureFolder + "\\" + ResolveInvalidFileNameCharacters ( aStructureName + "  .  " + aClassName + "  .  " + aRelatedClassName + "  .  Item  .  Set" + ".crm" ) ;
